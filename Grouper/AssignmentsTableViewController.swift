...
class AssignmentsTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        if defaults.value(forKey: "isStudent") as! Bool == true {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let destinationVC = segue.destination as! AddAssignmentViewController
        
        destinationVC.students = classSelected[index].members
        destinationVC.numGroups = classSelected[index].members.count
    }
